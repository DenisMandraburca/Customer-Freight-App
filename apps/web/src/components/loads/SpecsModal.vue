<template>
  <teleport to="body">
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 p-4" @click="emit('close')">
      <div class="max-h-[90vh] w-full max-w-xl overflow-auto rounded-xl bg-white p-4 shadow-xl dark:bg-zinc-900" @click.stop>
